...
public class UserHistory {
	...
	//Required for Separate Entity
	private int id;
	//Required for One to Many - Bi- Directional
	private User user;
	...
	public String toString() {
		return "UserHistory [entryTime=" + entryTime + ", entry=" + entry + ", id=" + id + ", user=" + user + "]";
	}

	/**
	 * Required for Value Mapping - One to Many - Set
	 */
	/*@Override
	public int hashCode() {
		final int prime = 31;
